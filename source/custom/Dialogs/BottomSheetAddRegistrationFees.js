...
const BottomSheetAddRegistrationFees = ({
  isVisible,
  onDialogCloseClick,
  item,
}) => {
        ...
        <View style={styles.container}>
          <View style={{justifyContent: 'center'}}>
            <LoginHeader
              route={
                item == ''
                  ? getStringMessage('lbl_add_reg_fees')
                  : getStringMessage('lbl_update_reg_fees')
              }
            />
            <TouchableOpacity
              onPress={() => {
          ...
          <View style={styles.viewContainer}>
            <InputField
              ...
              number
              isImage={false}
              inputTitle={getStringMessage('lbl_hint_reg_fee_amount')}
...
export default BottomSheetAddRegistrationFees;
